...
export interface numberRecognitionSetup {
...
export function numberRecognition(els, state) {
    let self = {} as recognitionClass

    class recognitionClass {
        els: SVGSVGElement
        state:numberRecognitionSetup
    ...
    return new recognitionClass(els, state);
}