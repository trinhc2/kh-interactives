...
export function decomposeNumber(_els, _setup) {
    ...
    class decomposeClass {
        ...
        constructor(els, setup) {
            ...
            this.els = els
            this.setup = setup
            this.refToOne = this.els.getElementById("A") as HTMLElement;
        ...
        generateDecompositionObjects(startingNumber) {
            ...
            for (let i = startingNumber; i > 0;) {
                ...
                gsap.set(number, { attr: { id: 'text' + (i), class: 'number' }, x: numBBox.x - (numBBox.width / 2), y: numBBox.y + this.yTextOffset, fontFamily: 'Poppins', textContent: i, fontSize: this.textSize, opacity: 0, fill : "#ffffff" })
